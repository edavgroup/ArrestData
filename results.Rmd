...
vcd::mosaic(ofns_desc~age_group+perp_sex,df_type,direction=c('v','h','v'),highlighting_fill=color, labeling = vcd::labeling_border(rot_labels = c(0, 0, 0, 0), abbreviate_labs = c(5, 1, 1,1)))
```
```{r}
