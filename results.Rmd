...
figure1 <- ggplot(data, aes(x=age_group))+ 
  geom_histogram(stat="count",position="identity", alpha=0.5, fill = "lightBlue")+
  coord_flip()+
...
## Crime Types
### Relationship between Type of Offenders and Crime Types
...
crime_by_category_plot <-ggplot(crime_by_category[1:7,], aes(x = Category, y = Frequency)) +     geom_histogram(stat="identity",alpha=0.5,fill = "lightBlue") + 
...
### Relationship between Locations and Crime Types



### Relationship between Time and Crime Types
