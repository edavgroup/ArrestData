...
With the arrest records, we plot the basic information (age, gender and race) for all arrests. Then we could depicting the portraits for those criminal group.
